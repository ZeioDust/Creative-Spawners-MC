...
public class ClientEvents {
    ...
    public static void registerSpecialRenderers(RegisterSpecialModelRendererEvent event) {
        event.register(
                ResourceLocation.fromNamespaceAndPath(CreativeSpawners.MODID, "item_spawner_inner"),
    ...
    public static void registerGuiLayers(RegisterGuiLayersEvent event) {
        event.registerAbove(
                ...
                ResourceLocation.fromNamespaceAndPath(CreativeSpawners.MODID, "creative_timer"),
